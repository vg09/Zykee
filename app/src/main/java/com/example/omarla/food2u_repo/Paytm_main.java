...
public class Paytm_main extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name=bundle.getString("cost");
        textViewPrice.setText(name);
    ...
    private void initializePaytmPayment(String checksumHash, Paytm paytm) {
        ...
        //finally starting the payment trans
        // /*action
