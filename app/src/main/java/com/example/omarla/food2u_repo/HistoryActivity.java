...
public class HistoryActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 1:
                    completedItemsHistory tab1 = new completedItemsHistory();
                    return tab1;
                case 0:
                    pendingItems tab2 = new pendingItems();
                    return tab2;
                default:
                    return null;
            }
    ...
    public void onBackPressed ()
        {Intent startMain = new Intent(HistoryActivity.this,CustomerDashboard.class);
