...
public class PendingAdapter extends BaseAdapter {
    ...
    public PendingAdapter(Context context, ArrayList arr_stall_name, ArrayList arr_item_name,ArrayList arr_item_cost,ArrayList arr_total_cost,ArrayList arr_date,ArrayList arr_list_quantity,ArrayList arr_img_url){
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        PendingAdapter.Holder holder = new PendingAdapter.Holder();
        View rowView;
