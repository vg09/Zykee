...
public class Mail extends javax.mail.Authenticator {
    ...
    public Mail() {
        ...
        _user = "food2uinfotech@gmail.com"; // username
        _pass = "project@123"; // password
        _from = "food2uinfotech@gmail.com"; // email sent from
        _subject = "Your password for login"; // email subject
        _body = ""; // email body
        ...
        if(!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") &&
            ...
            Session session = Session.getInstance(props, new javax.mail.Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("food2uinfotech@gmail.com","project@123");
                }
            });
...
// send email
            ...
            try {
                t.connect("smtp.gmail.com","food2uinfotech@gmail.com","project@123");
